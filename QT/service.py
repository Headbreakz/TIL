...
class test(QMainWindow, Ui_MainWindow):
    ...
    def find_patient_image_list(self):
        ...
        # self.cmd = "select chart_index,patient_name,patient_birth_info FROM patient_list where patient_visit_day = '{}.{}.{}' and patient_name ='{}' ".format(
        #     self.day_year, self.day_month, self.day_day,self.patient_name)
        # self.cur.execute(self.cmd)
        # self.conn.commit()
        # ar = self.cur.fetchall()
        #
        ...
        self.pre_info_image = self.info_image
        print(self.pre_info_image)
